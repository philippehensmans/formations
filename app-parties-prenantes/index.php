...
<head>
    ...
    <title>Cartographie des Parties Prenantes - Identification</title>
...
<body class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div class="bg-gray-900 text-white p-6 text-center">
            <h1 class="text-2xl font-bold">Cartographie des Parties Prenantes</h1>
            <p class="text-gray-400 mt-1">Matrice Influence x Interet</p>
        </div>
        ...
        <div class="p-6">
            ...
            <form method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="code" required
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-900 focus:outline-none text-lg">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="prenom" required
                            class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-blue-900 focus:outline-none"
                ...
                <button type="submit"
                    class="w-full bg-gray-900 text-white py-3 rounded-lg font-semibold hover:bg-gray-800 transition shadow-lg">
            ...
            <form method="POST" class="space-y-4">
                ...
                <button type="submit"
                    class="w-full bg-blue-900 text-white py-3 rounded-lg font-semibold hover:bg-blue-800 transition shadow-lg">
