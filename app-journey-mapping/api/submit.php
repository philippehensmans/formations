<?php
/**
 * API de soumission finale de l'analyse Journey Mapping
 */
...
if (!$analyse) {
    ...
    echo json_encode(['error' => 'Aucune analyse Journey Mapping trouvee']);
    exit;
}
...
echo json_encode([
    'success' => true,
    'message' => 'Analyse Journey Mapping soumise avec succes'
]);
?>
