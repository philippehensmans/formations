...
// Recuperer la session (pour afficher l'eventuel sujet de reflexion)
...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
    ...
    <div class="max-w-5xl mx-auto p-4 sm:p-6">
        ...
        <!-- Sujet de reflexion (defini par le formateur) -->
        <?php if (!empty($session['sujet'])): ?>
        <div class="bg-blue-50 border-l-4 border-blue-400 rounded-xl shadow p-5 mb-6">
            <h2 class="text-sm font-bold text-blue-800 uppercase mb-1">Sujet de reflexion</h2>
