...
define('APP_NAME', 'Analyse SWOT');
define('APP_COLOR', 'red');
define('DB_PATH', __DIR__ . '/data/swot.db');
...
function initDatabase($db) {
    ...
    // Table des analyses SWOT
    $db->exec("CREATE TABLE IF NOT EXISTS analyses (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        user_id INTEGER NOT NULL,
        session_id INTEGER,
        titre_projet TEXT,
        swot_data TEXT DEFAULT '{}',
