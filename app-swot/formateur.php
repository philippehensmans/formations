    ...
    <body class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="mt-4 text-center">
                <a href="index.php" class="text-<?= $appColor ?>-600 hover:text-<?= $appColor ?>-800 text-sm">
        ...
        switch ($_POST['action']) {
            ...
            case 'delete_session':
                ...
                if (!empty($participants)) {
                    ...
                    $db->prepare("DELETE FROM analyses WHERE participant_id IN ($placeholders)")->execute($participants);
                }
        ...
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <a href="index.php" class="px-4 py-2 text-gray-600 hover:text-gray-800">Application</a>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="divide-y max-h-96 overflow-y-auto">
                    <?php foreach ($sessions as $session): ?>
                        <div class="p-4 hover:bg-gray-50 <?= ($selectedSession && $selectedSession['id'] == $session['id']) ? 'bg-blue-50 border-l-4 border-blue-600' : '' ?>">
                            ...
                            <table class="w-full text-sm">
                                <thead>
                                    <tr class="border-b">
                                        ...
                                        <th class="text-center py-2">Analyse</th>
                                    ...
                                    <?php foreach ($participants as $p): ?>
                                        <tr class="border-b hover:bg-gray-50">
                                            ...
                                            <td class="py-2 text-center">
                                                <?php if (!empty($p['swot_data'])): ?>
                                                    <span class="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs">Complete</span>
                                                <?php else: ?>
                                                    <span class="px-2 py-1 bg-gray-100 text-gray-600 rounded text-xs">Vide</span>
                                                <?php endif; ?>
                                            </td>
                                            <td class="py-2 text-center">
                                                <?php if ($p['submitted']): ?>
