        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
            <div class="flex justify-between items-center p-6 border-b">
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">Synthese IA - Auto-Diagnostic Communication</h3>
                </div>
            ...
            <div class="p-4 border-t flex justify-end gap-3">
                ...
                <button onclick="printAISummary()" class="px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg flex items-center gap-2">
    ...
    <script>
        ...
        async function generateAISummary() {
            ...
            document.getElementById('aiContent').innerHTML = `
                <div class="flex flex-col items-center justify-center py-16">
                    ...
                    <p class="text-gray-600 font-medium">Analyse des diagnostics en cours...</p>
                    <p class="text-gray-400 text-sm mt-2">Claude analyse les auto-diagnostics de tous les participants</p>
                </div>
            `;
        ...
        function printAISummary() {
            ...
            w.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Synthese IA - <?= h($session['nom']) ?></title>
                ...
                <body><h1 class="text-2xl font-bold mb-2">Synthese IA - Auto-Diagnostic Communication</h1>
