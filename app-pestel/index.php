        ...
        if (empty($code) || empty($prenom) || empty($nom)) {
            ...
            if (!$session) {
                ...
                if ($participant) {
                    ...
                    // Creer son analyse PESTEL vide
                    $stmt = $db->prepare("INSERT INTO analyse_pestel (participant_id, session_id, pestel_data) VALUES (?, ?, ?)");
                    $stmt->execute([$participantId, $session['id'], json_encode(getEmptyPestel())]);
                }
...
<head>
    ...
    <title>Analyse PESTEL - Identification</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 text-center">
            ...
            <p class="text-indigo-200 mt-1">Analyse macro-environnementale</p>
        </div>
        ...
        <div class="p-6">
            ...
            <form method="POST" class="space-y-4">
                ...
                <button type="submit"
                    class="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition shadow-lg">
